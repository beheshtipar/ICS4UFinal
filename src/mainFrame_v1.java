...
public class mainFrame_v1 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {			//secure way to run swing applications
			public void run() {
				try {
					mainFrame_v1 window = new mainFrame_v1();
	 ...
	 * @throws IOException 
	 */
	public mainFrame_v1() throws IOException {
		initialize();
	}
		...
		btnStart.addMouseListener(new MouseAdapter(){
			public void mouseClicked(MouseEvent me) {
				try {
					...
					new guiGuess_v0_6(checkPassive.isSelected(), checkDefault.isSelected(), checkUlti.isSelected());
					frame.dispose();
				} catch (IOException e) {
